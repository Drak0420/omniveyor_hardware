...
"""
    ...
    def joy_cb(self, msg):
        ...
        ljoy_hort, ljoy_vert, l2, rjoy_hort, rjoy_vert, r2, dpad_hort, dpad_vert = msg.axes
        cross, circle, triangle, square, l1, r1, l2_en, r2_en, share, option, ps_logo, ljoy_press, rjoy_press = msg.buttons
        x = y = omega = 0
